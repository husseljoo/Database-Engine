    ...
    public void updateTable(String str_TableName,
		...
		try {
			...
			if(arrOfStr[1].equals(clusteringKey)) {//or arrOfStr[3]==true and parse it to Boolean clustering key in metadata
				...
				currentColumnValue=htbl_ColNameValue.get(arrOfStr[1])+""; //(String)htbl_ColNameValue.get(arrOfStr[1])//gets value of current column
...
//    	}
    	...
    	dbApp.updateTable("Student","10",htbl_TEST);
